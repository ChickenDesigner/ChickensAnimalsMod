...
public class PigeonRenderer extends MobRenderer<Pigeon, HierarchicalModel<Pigeon>> {

    private final PigeonModel<Pigeon> adultModel;
    private final BabyPigeonModel<Pigeon> babyModel;
    ...
    @Override
    public void render(Pigeon entity, float entityYaw, float partialTicks, PoseStack poseStack, MultiBufferSource buffer, int packedLight) {
    ...
    @Override
    public ResourceLocation getTextureLocation(Pigeon pigeon) {
