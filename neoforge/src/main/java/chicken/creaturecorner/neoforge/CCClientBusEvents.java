...
public class CCClientBusEvents {
    ...
    public static void registerLayer(EntityRenderersEvent.RegisterLayerDefinitions event) {
        ...
        event.registerLayerDefinition(CCModelLayers.CARACARA, CaracaraModel::createBodyLayer);
        event.registerLayerDefinition(CCModelLayers.BABY_CARACARA, BabyCaracaraModel::createBodyLayer);
