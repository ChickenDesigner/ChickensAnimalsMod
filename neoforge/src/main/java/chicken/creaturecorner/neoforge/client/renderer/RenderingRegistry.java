...
//        event.registerEntityRenderer(CCEntities.NEW_PIGEON.get(), NewPigeonRenderer::new);
        event.registerEntityRenderer(CCEntities.COYOTE_TYPE.get(), chicken.creaturecorner.client.renderer.geckolib.CoyoteRenderer::new);
        event.registerEntityRenderer(CCEntities.CARACARA_TYPE.get(), chicken.creaturecorner.client.renderer.geckolib.CaracaraRenderer::new);
